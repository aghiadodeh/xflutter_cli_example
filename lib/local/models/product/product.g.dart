...
IsarProduct _isarProductDeserialize(
  ...
  final object = IsarProduct(
    ...
    discountPercentage: reader.readDoubleOrNull(offsets[3]),
    id: reader.readLongOrNull(offsets[4]),
    images: reader.readStringOrNullList(offsets[5]),
    isarId: id,
    price: reader.readDoubleOrNull(offsets[6]),
    rating: reader.readDoubleOrNull(offsets[7]),
    stock: reader.readDoubleOrNull(offsets[8]),
...
extension IsarProductQueryWhere
  ...
  QueryBuilder<IsarProduct, IsarProduct, QAfterWhereClause> isarIdEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProduct, IsarProduct, QAfterWhereClause> isarIdNotEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProduct, IsarProduct, QAfterWhereClause> isarIdGreaterThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<IsarProduct, IsarProduct, QAfterWhereClause> isarIdLessThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension IsarProductQueryFilter
  ...
  QueryBuilder<IsarProduct, IsarProduct, QAfterFilterCondition> brandContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProduct, IsarProduct, QAfterFilterCondition> brandMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProduct, IsarProduct, QAfterFilterCondition> categoryMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<IsarProduct, IsarProduct, QAfterFilterCondition> isarIdEqualTo(
      Id? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isarId',
  ...
  QueryBuilder<IsarProduct, IsarProduct, QAfterFilterCondition> titleContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<IsarProduct, IsarProduct, QAfterFilterCondition> titleMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension IsarProductQueryWhereDistinct
  ...
  QueryBuilder<IsarProduct, IsarProduct, QDistinct> distinctByBrand(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProduct, IsarProduct, QDistinct> distinctByCategory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProduct, IsarProduct, QDistinct> distinctByThumbnail(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarProduct, IsarProduct, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension IsarProductQueryProperty
  ...
  QueryBuilder<IsarProduct, double?, QQueryOperations>
