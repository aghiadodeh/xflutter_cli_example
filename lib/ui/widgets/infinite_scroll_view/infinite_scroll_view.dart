...
class InfiniteScrollView<VM extends PaginationViewModel<T>, T extends Object> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedInfiniteScrollView<T>(
      ...
      errorWidget: PaginationErrorWidget(retry: retry ?? () => viewModel.fetchData(viewModel.paginationParams.page)),
      physics: physics ?? scrollPhysics,
      onRefresh: onRefresh,
      gridDelegate: gridDelegate,
      spawnIsolate: spawnIsolate,
      scrollDirection: scrollDirection,
      itemBuilder: (index, item) => CustomizedAnimatedWidget(child: itemBuilder.call(index, item)),
    );
  }
}
