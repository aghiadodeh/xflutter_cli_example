...
abstract class BaseViewModel extends LifeCycle {
  ...
  ///
  /// [loading] is optional [MutableLiveData] params which you want to appear while request in-progress
  ...
  /// [callback] return nullable [X] result [X] if [request] success else return null
